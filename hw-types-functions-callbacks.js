...
console.log("sumNul>>>>",sum(867, 5309) === 6176);
console.log("sumNul>>>>",sum('867', 5309) === null);
console.log("sumNul>>>>",sum(true, 5) === null);
...
console.log("isNegative>>>>>",isNegative(10) === false)
console.log("isNegative>>>>>",isNegative(0) === false)
console.log("isNegative>>>>>",isNegative(-999) === true)
...
console.log("findMin>>>>>", minimum(1,2,4,0) === 0)
console.log("findMin>>>>>", minimum(1000,-2,-99,50) === -99)
console.log("findMin>>>>>", minimum(-1000,-2,-99,50) === -1000)
console.log("findMin>>>>>", minimum(1000,-2,99,50) === -2)
...
console.log("justOneString>>>", justOneString('a',5) === true)
console.log("justOneString>>>", justOneString(6,'dotron') === true)
console.log("justOneString>>>", justOneString('peanut','butter') === false)
console.log("justOneString>>>", justOneString(8,null) === false)
